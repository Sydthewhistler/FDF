...
/*   Updated: 2025/04/27 18:36:41 by scavalli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int make_iso_x(int x, int y, int z, t_data *data)
{
	...
	final_x = (x * cos(data->mvt.angle_y) * cos(data->mvt.angle_z) + 
					(y * cos(data->mvt.angle_x) - z * sin(data->mvt.angle_x)) * 
					(-sin(data->mvt.angle_z)) + 
					(y * sin(data->mvt.angle_x) + z * cos(data->mvt.angle_x)) * 
					sin(data->mvt.angle_y) * cos(data->mvt.angle_z));
    final_y = (x * cos(data->mvt.angle_y) * sin(data->mvt.angle_z) + 
					(y * cos(data->mvt.angle_x) - z * sin(data->mvt.angle_x)) * 
					cos(data->mvt.angle_z) + 
					(y * sin(data->mvt.angle_x) + z * cos(data->mvt.angle_x)) * 
					sin(data->mvt.angle_y) * sin(data->mvt.angle_z));
...
int make_iso_y(int x, int y, int z, t_data *data)
{
	...
	final_z = (-x * sin(data->mvt.angle_y) + 
					(y * sin(data->mvt.angle_x) + z * cos(data->mvt.angle_x)) * 
					cos(data->mvt.angle_y));
